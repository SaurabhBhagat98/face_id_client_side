...
if(!isset($_SESSION['uname'])){
    header('Location: admin_subpage1.php');
}
...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <div class="box">
                <div class="form-content">
                    <h3 class="form-title">Employee Details</h3>

                        <input type="text" id="txt_uname" name="txt_uname" placeholder="Employee Name" onfocus="this.value=''" onblur="field_blur(this, '');" class="email" />
    ...
    $Name = mysqli_real_escape_string($con2,$_POST['txt_uname']);
    if ($Name != ""){
        $sql_query = "SELECT * FROM `employee_details` WHERE UserNames='$Name'";
        $result=$con2->query($sql_query); 
