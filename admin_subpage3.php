...
if(!isset($_SESSION['uname'])){
    header('Location: admin_subpage3.php');
}
...
<html lang="en">
  ...
  <body>
            ...
            <div class="box">
                <div class="form-content">
                    <h3 class="form-title">Enter Details</h3>
                        ...
                        <input type="text" id="txt_uname" name="txt_Id" placeholder="Id" onfocus="this.value=''" onblur="field_blur(this, '');" class="email" />
  
                        <input type="text" id="txt_uname" name="txt_Name" placeholder="Name" onfocus="this.value=''" onblur="field_blur(this, '');" class="email" />
    ...
    $Id = mysqli_real_escape_string($con3,$_POST['txt_Id']);
    $Name = mysqli_real_escape_string($con3,$_POST['txt_Name']);
    $Table_Name=$Id.'_'.$Name;
    if ($Id != "" && $Name != ""){
        $sql_query = "SELECT * FROM `$Table_Name`";
        $result=$con3->query($sql_query); 
